                    ...
                    <div id="step-2" class="space-y-4 hidden">
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            ...
                            <div>
                                ...
                                <input type="number" name="age" id="reg-age" min="18" max="100" placeholder="Umur"
                                       value="<?php echo fval('age', $form_data) ?: ''; ?>"
                                       class="w-full py-3 px-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#ff6f91]/20 focus:border-[#ff6f91] transition text-sm placeholder-gray-400 text-gray-800 text-center <?php echo ferr_class('age', $form_errors); ?>" required>
                            </div>
                        </div>
