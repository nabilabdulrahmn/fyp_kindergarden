...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['hantar_mesej'])) {
    ...
    // Semak sekuriti penerima: Mestilah admin ATAU parent kepada pelajar kelas guru ini
    $allowed_sql = "
        ...
        WHERE c.teacher_id = '$teacher_id' AND u.id = '$receiver_id'
    ";
...
// --- QUERY SENARAI PENERIMA DIBENARKAN (ADMINS & PARENTS KELAS CIKGU INI SAHAJA) ---
$recipients = [];
$recipient_sql = "
